...
export async function initSettings() {
	...
	if (!currentSettings.trackerDef) {
		...
		// FIX: Don't let empty strings saved by a broken prior install override populated defaults.
		const cleanCurrentSettings = Object.fromEntries(
			Object.entries(currentSettings).filter(([_, v]) => v !== "" && v !== null && v !== undefined)
		);
		Object.assign(extensionSettings, defaultSettings, cleanCurrentSettings);
	}
